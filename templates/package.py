...
def _generate_default_files(validated_data: dict[str, Any]) -> tuple[AnyFile, ...]:
    ...
    return (
            ...
            File(relative_path=Path(".gitignore"), content="/sandbox.py\n/.idea\n/.env\n/.venv\n/.vscode\n/.run/\n*__pycache__\n/docs/build/\n"),
            PackageInitPy(),
...
class PythonPackage(Template, _DescriptionMixin):
    ...
    files: tuple[AnyFile, ...] = Field(
        default_factory=_generate_default_files
    )
